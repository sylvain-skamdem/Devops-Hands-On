...
echo 'export CLUSTER_NAME=useast1m.k8s.druide.in' > /home/ansadmin/.bash_profile
echo 'export KOPS_STATE_STORE=s3://useast1m.k8s.druide.in' >> /home/ansadmin/.bash_profile
